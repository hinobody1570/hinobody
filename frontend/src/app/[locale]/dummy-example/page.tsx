 ...
 *
 * File location: frontend/src/app/[locale]/dummy-example/page.tsx
 * URL: /en/dummy-example, /ko/dummy-example, etc.
 *
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-6">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
            ...
            <ul className="list-disc list-inside text-blue-700 space-y-1">
              <li>
                <strong>File Path:</strong> app/[locale]/dummy-example/page.tsx
              </li>
              <li>
                <strong>URL Pattern:</strong> /{"{locale}"}/dummy-example
              </li>
              <li>
                <strong>Route Type:</strong> Public (accessible without login)
              </li>
              <li>
                <strong>Locale Support:</strong> en, ko, zh, ja
              </li>
            </ul>
          </div>
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-6 mb-6">
            ...
            <ol className="list-decimal list-inside text-purple-700 space-y-2">
              <li>
                Create a folder in <code className="bg-purple-100 px-1 rounded">app/[locale]/</code>
              </li>
              <li>
              ...
              <li>
                The route is automatically available at <code className="bg-purple-100 px-1 rounded">/{"{locale}"}/your-route-name</code>
              </li>
